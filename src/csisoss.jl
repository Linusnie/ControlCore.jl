...
function inv{T}(s::CSisoSs{T})
  # TODO: Implement
  throw(ErrorException("inv(s) for s::CSisoSs is not implemented"))
end

function zeros{T}(s::CSisoSs{T})
  # TODO: Implement
  throw(ErrorException("zeros(s) for s::CSisoSs is not implemented"))
end

function poles{T}(s::CSisoSs{T})
  # TODO: Implement
  throw(ErrorException("poles(s) for s::CSisoSs is not implemented"))
end
