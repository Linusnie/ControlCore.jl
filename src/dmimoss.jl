...
function inv{T}(s::DMimoSs{T})
  # TODO: Implement
  throw(ErrorException("inv(s) for s::DMimoSs is not implemented"))
end

function zeros{T}(s::DMimoSs{T})
  # TODO: Implement
  throw(ErrorException("zeros(s) for s::DMimoSs is not implemented"))
end

function poles{T}(s::DMimoSs{T})
  # TODO: Implement
  throw(ErrorException("poles(s) for s::DMimoSs is not implemented"))
end
