...
function inv{T}(s::CMimoSs{T})
  # TODO: Implement
  throw(ErrorException("inv(s) for s::CMimoSs is not implemented"))
end

function zeros{T}(s::CMimoSs{T})
  # TODO: Implement
  throw(ErrorException("zeros(s) for s::CMimoSs is not implemented"))
end

function poles{T}(s::CMimoSs{T})
  # TODO: Implement
  throw(ErrorException("poles(s) for s::CMimoSs is not implemented"))
end
