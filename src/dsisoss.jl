...
function inv{T}(s::DSisoSs{T})
  # TODO: Implement
  throw(ErrorException("inv(s) for s::DSisoSs is not implemented"))
end

function zeros{T}(s::DSisoSs{T})
  # TODO: Implement
  throw(ErrorException("zeros(s) for s::DSisoSs is not implemented"))
end

function poles{T}(s::DSisoSs{T})
  # TODO: Implement
  throw(ErrorException("poles(s) for s::DSisoSs is not implemented"))
end
