...
@test typeof(s2)     == ControlCore.DSisoRational{Float64,Int,Float64}
...
@test typeof(s5)     == ControlCore.DSisoRational{Rational{Int},Rational{Int},Int}
@test typeof(s6)     == ControlCore.DSisoRational{Int,Int,Int}
