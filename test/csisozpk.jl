...
@test typeof(s1)     == ControlCore.CSisoZpk{Int,Int,Int,Int}
@test typeof(s2)     == ControlCore.CSisoZpk{Float64,Int,Float64,Int}
@test typeof(s3)     == ControlCore.CSisoZpk{Float64,Int8,Int8,Float64}
@test typeof(s4)     == ControlCore.CSisoZpk{Rational{Int},Rational{Int},Int,Int}

# Conversions
@test promote_type(typeof(s1), Float64) == ControlCore.CSisoZpk
@test promote_type(ControlCore.CSisoZpk{Int}, Float64) == ControlCore.CSisoZpk
