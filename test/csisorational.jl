...
@test typeof(s1)     == ControlCore.CSisoRational{Int,Int,Int}
@test typeof(s2)     == ControlCore.CSisoRational{Float64,Int,Float64}
@test typeof(s3)     == ControlCore.CSisoRational{Float64,Float64,Float64}
@test typeof(s4)     == ControlCore.CSisoRational{Float64,Float64,Float64}
@test typeof(s5)     == ControlCore.CSisoRational{Rational{Int},Rational{Int},Int}
